...
import (
	...
	"github.com/copyco6628/go-opera/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/copyco6628/go-opera/gossip/emitter External,TxPool,TxSigner,Signer
